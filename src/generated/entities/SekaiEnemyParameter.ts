...
@ObjectType()
@Entity({ name: 'sekai_enemy_parameter' })
export class SekaiEnemyParameter extends BaseEntity {
  @Field(type => ID)
  @PrimaryColumn({ name: 'sekai_enemy_id', type: 'integer' })
  sekaiEnemyId: number;
