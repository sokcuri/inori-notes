...
@ObjectType()
@Entity({ name: 'clan_battle_last_attack_reward' })
export class ClanBattleLastAttackReward extends BaseEntity {
  @Field(type => ID)
  @PrimaryColumn({ name: 'last_attack_reward_id', type: 'integer' })
